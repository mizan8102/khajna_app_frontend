...
const recentSales = (event) => {
    if (event.value.code === '0') {
        customersTable.value = customersTable1;
    } else {
        customersTable.value = customersTable2;
    }
};
    ...
    <div class="grid">
        ...
        <div class="col-12 md:col-4">
            <div class="card p-0">
                ...
                <div class="timeline-content pb-3">
                    <Timeline :value="timelineEvents" class="custom-timeline py-0 px-3">
                        <template #marker="slotProps">
                            <span class="custom-marker border-circle p-1 w-2rem h-2rem flex justify-content-center align-items-center" :style="{ backgroundColor: slotProps.item.iconColor }">
            ...
            <div class="card">
                ...
                <div class="country-graph">
                    <div class="flex justify-content-center">
                        <Chart type="doughnut" id="country-chart" :data="countryChart" :options="countryChartOptions" :style="{ width: '75%' }"></Chart>
                    </div>
                </div>
        ...
        <div class="col-12 md:col-8">
            <div class="card">
                ...
                <div class="graph">
                    <Chart type="line" id="revenue-chart" :data="revenueChart" :options="revenueChartOptions"></Chart>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 md:col-8">
            <div class="card widget-table">
                ...
                <DataTable ref="dt" :value="customersTable" :selection="selectedCustomers1" dataKey="id" responsiveLayout="scroll" :rowHover="true" :rows="10" :paginator="true">
            ...
            <div class="card widget-target">
                ...
                <div class="mt-4 relative text-red-500 flex flex-column justify-content-between" style="min-height: 235px">
                    ...
                    <div class="item success mb-3">
                        ...
                        <ProgressBar color="#0BD18A" :value="100" :showValue="false" style="box-shadow: 0px 0px 10px rgb(11 209 138 / 30%)"></ProgressBar>
                        <span class="day bottom-0 text-color-secondary block mt-1">Mon</span>
                    </div>
                    <div class="item mb-3">
                        <span class="block mb-1">70%</span>
                        <ProgressBar color="#FC6161" :value="70" :showValue="false"></ProgressBar>
                        <span class="day bottom-0 text-color-secondary block mt-1">Tue</span>
                    </div>
                    <div class="item today mb-3">
                        <span class="block mb-1">22%</span>
                        <ProgressBar color="#FC6161" :value="22" :showValue="false"></ProgressBar>
